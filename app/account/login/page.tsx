...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (state?.success && !redirecting.current) {
      ...
      }, 100); // 0.1 second delay to show the message
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  type="checkbox"
                  disabled={state?.success}
                  className="h-4 w-4 rounded border-stone-300 text-amber-700 focus:ring-amber-500 focus:ring-offset-0 transition"
                />
              ...
              <Link
                href="#"
                className="text-sm font-medium text-[#1E4A76] hover:text-amber-800 transition-colors underline-offset-2 hover:underline"
              >
                Forgot password?
              </Link>
            </div>
