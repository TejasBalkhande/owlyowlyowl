// app/GED/GEDClient.tsx (Client Component)
"use client";
...
// ========== GED Understanding Cards ==========
const understandingCards = [
  {
    title: "What is the GED?",
    text: "The GED (General Educational Development) is a high school equivalency test with four subjects: Reasoning Through Language Arts, Mathematical Reasoning, Science, and Social Studies.",
    icon: "BookOpen"
  },
  {
    title: "GED Test Format",
    text: "Computer-based test with multiple-choice, drag-and-drop, fill-in-the-blank, and extended response questions. Pass each subject with a score of 145+.",
    icon: "LayoutTemplate"
  },
  {
    title: "Scoring System",
    text: "Each subject scored 100-200. Passing: 145+; College Ready: 165+; College Ready + Credit: 175+. Total composite score up to 800.",
    icon: "Award"
  },
  {
    title: "Test Duration",
    text: "Total test time is approximately 7.5 hours. Language Arts: 150 min, Math: 115 min, Science: 90 min, Social Studies: 70 min.",
    icon: "Clock"
  },
  {
    title: "Question Types",
    text: "Multiple choice, short answer, essay (extended response), drag-and-drop, hot spot, and technology-enhanced items.",
    icon: "HelpCircle"
  },
  {
    title: "Preparation Tips",
    text: "Focus on time management, practice with official GED Ready tests, and review subject-specific strategies for each content area.",
    icon: "Brain"
  }
];
...
const testSections = [
  {
    ...
    module: "Part I & II",
    time: "150 Minutes",
    questions: "~45-51 Questions",
    format: "Reading comprehension, grammar, and extended response essay"
  },
  {
    section: "Mathematical Reasoning",
    module: "Calculator & No-Calculator",
    time: "115 Minutes",
    questions: "~46 Questions",
    format: "Algebra, geometry, data analysis, and word problems"
  },
  {
    section: "Science",
    module: "Life, Physical, & Earth Science",
    time: "90 Minutes",
    questions: "~34 Questions",
    format: "Reading passages, data interpretation, and scientific reasoning"
  },
  {
    section: "Social Studies",
    module: "History, Civics, Economics",
    time: "70 Minutes",
    questions: "~35 Questions",
    format: "Text analysis, data interpretation, and social studies concepts"
  }
];

// ========== GED Topic/Section Weight (Updated from Official Assessment Guide) ==========
const subjects = [
  {
    title: "Reasoning Through Language Arts",
    time: "150 Minutes",
    items: [
      { label: "Informational Texts", pct: 75, desc: "Reading comprehension using non-fiction, workplace, and historical texts." },
      { label: "Literature Texts", pct: 25, desc: "Reading comprehension using fiction and literary excerpts." },
      { label: "Grammar & Extended Response", pct: "Integrated", desc: "Embedded editing questions and a 45-minute argumentative essay." }
    ]
  },
  {
    ...
    time: "115 Minutes",
    items: [
      { label: "Algebraic Problem Solving", pct: 55, desc: "Linear equations, inequalities, functions, and patterns." },
      { label: "Quantitative Problem Solving", pct: 45, desc: "Number sense, geometry, statistics, and data analysis." }
    ]
  },
  {
    title: "Science",
    time: "90 Minutes",
    items: [
      { label: "Life Science", pct: 40, desc: "Cell structures, genetics, human body, ecosystems." },
      { label: "Physical Science", pct: 40, desc: "Physics, chemistry, energy, motion." },
      { label: "Earth & Space Science", pct: 20, desc: "Geology, weather, astronomy." }
    ]
  },
  {
    ...
    time: "70 Minutes",
    items: [
      { label: "Civics & Government", pct: 50, desc: "U.S. government structure, constitutional rights, and elections." },
      { label: "U.S. History", pct: 20, desc: "Key historical events, movements, and documents." },
      { label: "Economics", pct: 15, desc: "Basic economic principles, supply and demand, labor." },
      { label: "Geography & the World", pct: 15, desc: "Maps, human migration, and global societal events." }
    ]
  }
];

// ========== GED Content Domains & Question Distribution ==========

const languageArtsDomains = [
  {
    domain: "Reading for Meaning (Informational & Literary)",
    description: "Interpret, analyze, and draw conclusions from informational texts (75%) and literary texts (25%).",
    skills: "Determine central ideas; analyze relationships between ideas; infer implicit meaning; understand author's purpose, tone, and text structure.",
    questions: "~18-22 items (Approx. \n35% of test)"
  },
  {
    domain: "Identifying and Creating Arguments",
    description: "Evaluate arguments and evidence in reading passages, and compose a clear, evidence-based written response.",
    skills: "Identify author's claims; evaluate relevance and sufficiency of evidence; distinguish valid arguments from faulty logic; develop logical arguments in writing (the essay).",
    questions: "~14-18 items +\n 1 Extended Response"
  },
  {
    domain: "Grammar and Language Conventions",
    description: "Apply standard English grammar, usage, and mechanics to edit and improve written communication in context.",
    skills: "Correct sentence fragments, run-ons, and awkward structures; ensure proper subject-verb agreement, pronoun usage, capitalization, and punctuation.",
    questions: "~10-14 items"
  }
];

// 2. Mathematical Reasoning Domains
const mathDomains = [
  {
    domain: "Quantitative Problem Solving",
    description: "Solve real-world problems involving numbers, operations, ratios, proportions, geometry, and data interpretation.",
    skills: "Perform operations with rational numbers; compute perimeter, area, surface area, and volume; analyze charts, graphs, and calculate probabilities/statistics.",
    questions: "~21 items (45% of test)"
  },
  {
    domain: "Algebraic Problem Solving",
    description: "Solve equations, inequalities, and systems; work with functions, linear relationships, and polynomials.",
    skills: "Write and solve linear equations and inequalities; evaluate algebraic expressions; interpret slope and intercepts on coordinate planes; evaluate functions.",
    questions: "~25 items (55% of test)"
  }
];
...
const scienceDomains = [
  {
    domain: "Life Science",
    description: "Demonstrate understanding of biological processes, ecosystems, and heredity.",
    skills: "Understand human body systems, cell structures and processes, health and nutrition, heredity, reproduction, and evolution.",
    questions: "~14 items (40% of test)"
  },
  {
    domain: "Physical Science",
    description: "Demonstrate understanding of physics and chemistry principles.",
    skills: "Analyze conservation, transformation, and flow of energy; understand work, motion, forces, and chemical properties/reactions.",
    questions: "~14 items (40% of test)"
  },
  {
    domain: "Earth & Space Science",
    description: "Demonstrate understanding of the Earth, its systems, and the cosmos.",
    skills: "Understand interactions between Earth's systems, weather and climate, Earth's structure, and the organization of the cosmos.",
    questions: "~6 items (20% of test)"
  }
];

// 4. Social Studies Domains
const socialStudiesDomains = [
  {
    domain: "Civics and Government",
    description: "Understand the foundations of the U.S. government, electoral systems, and citizen rights.",
    skills: "Analyze the U.S. Constitution, branches of government, levels of government (local/state/federal), and the electoral system.",
    questions: "~17 items (50% of test)"
  },
  {
    domain: "United States History",
    description: "Analyze key historical documents, events, and eras from colonization to the present.",
    skills: "Interpret historical perspectives; understand the Revolutionary War, Civil War, Civil Rights Movement, and major historical shifts.",
    questions: "~7 items (20% of test)"
  },
  {
    domain: "Economics",
    description: "Understand basic economic principles, markets, and the role of government in the economy.",
    skills: "Identify concepts of supply and demand, micro/macroeconomics, consumer economics, and global economic events.",
    questions: "~5 items (15% of test)"
  },
  {
    domain: "Geography and the World",
    description: "Analyze spatial relationships, human migration, and global societal events.",
    skills: "Read and interpret maps; analyze human movement, cultural diffusion, and human interaction with the environment.",
    questions: "~5 items (15% of test)"
  }
];
...
// Helper to render question text with line breaks
...
// ========== REUSABLE CONTENT DOMAINS TABLE COMPONENT ==========
interface ContentDomainTableProps {
  title: string;
  timeInfo: string;
  domains: Array<{
    domain: string;
...
const ContentDomainTable = ({ title, timeInfo, domains }: ContentDomainTableProps) => {
  return (
    <div className="mb-12">
      <div className="flex items-baseline flex-wrap gap-2 mb-4">
        <h2 className="text-xl font-semibold text-[#1E4A76]">{title}</h2>
            ...
            {domains.map((row, idx) => (
              ...
              >
                ...
                <td className="px-5 py-4 text-[#1E4A76] font-bold whitespace-nowrap align-top">
                  <span className="inline-flex items-center  px-2.5 py-0.5 text-xs font-medium text-[#1E4A76]">
                    {renderQuestionText(row.questions)}
                  </span>
                </td>
              </tr>
            ))}
...
export default function GEDClient({ username, isLoggedIn, dashboardStats }: GEDClientProps) {
  const [showAllUnderstanding, setShowAllUnderstanding] = React.useState(false);
  const [showAllContentTables, setShowAllContentTables] = React.useState(false);
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-[bg-gray-50] w-full overflow-visible">
        <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              >
                <div className="w-full md:w-3/5 flex flex-col space-y-2">
                  <div className="flex items-center border border-[#E2E8F0] rounded-full px-3 py-1.5 md:py-2 w-full bg-white text-sm shadow-sm focus-within:ring-2 focus-within:ring-[#1E4A76]/20 transition mt-3 md:mt-6">
                    ...
                    <input
                      type="text"
                      placeholder="Search for GED books, notes, Question Banks"
                  ...
                  <div className="flex flex-row items-center gap-1 sm:gap-4">
                    ...
                    <div className="flex flex-col">
                      <h1 className="text-[15px] sm:text-lg md:text-3xl font-bold font-sans leading-snug">
                        <span className="text-black">Strategic GED Preparation</span>{" "}
                      ...
                      <p className="text-[#4A5568] font-times text-[12px] sm:text-[14px] md:text-[17px] mt-1 leading-snug">
                        Comprehensive GED Guide: Strategies, Practice, and Resources to Maximize Your Score
                      </p>
              ...
              <div className="w-full overflow-x-auto pt-3 pb-4 mb-3">
                <div className="flex flex-wrap md:flex-nowrap gap-2 md:gap-2 justify-center md:justify-start">
                  {[
                    { id: 'understanding-sat', label: 'Understanding the GED', icon: 'BookOpen' },
              ...
              {/* Digital GED Adaptive Practice Section */}
              <section>
                <div className="w-full py-3 flex flex-col-reverse md:flex-row items-center md:items-start gap-6">
                  <div className="w-full md:w-1/2 flex flex-col items-start space-y-2">
                    <h1 className="text-2xl font-semibold text-left font-sans">
                      <span className="text-black">Digital GED</span>{" "}
                      <span className="text-[#1E4A76]">Adaptive Practice</span>
                    </h1>
                    <h2 className="text-[#4A5568] text-left font-times text-[17px] lg:w-150">
                      Master the GED with adaptive practice questions, full-length mocks, and instant explanations for all four subjects.
                    </h2>
                    <div className="flex flex-col gap-3 pt-4 w-full md:w-auto font-medium">
                      <Link href="/ged/Practice-Questions#full-length-mock-test" className="w-full md:w-64 border border-[#1E4A76] bg-white text-[#1E4A76] py-2 rounded-md hover:bg-[#1E4A76] hover:text-white transition text-center block shadow-sm">
                        Full-Length GED Mocks
                      </Link>
                      <Link href="/ged/Practice-Questions" className="w-full md:w-64 border border-[#1E4A76] bg-white text-[#1E4A76] py-2 rounded-md hover:bg-[#1E4A76] hover:text-white transition text-center block shadow-sm">
                        Topic-wise Practice
                      </Link>
                    </div>
                  </div>
                ...
                <div className="w-full py-4 flex flex-col md:flex-row md:items-start gap-6">
                  ...
                  <div className="w-full md:flex-1 flex flex-col space-y-4">
                    ...
                    <h2 className="text-[#4A5568] font-times text-[17px] md:text-right text-center">
                      Free video lessons covering GED subjects, strategies, and practice problems to help you
              ...
              {/* GED Study Resources Section */}
              <section className="w-full">
                <div className="w-full py-6">
                  <h1 className="text-2xl font-semibold font-sans text-[#1E4A76]">GED Study Resources</h1>
                  <div className="w-full mt-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="flex flex-col items-center text-center space-y-4">
                      <div className="relative w-full h-52 md:h-64 bg-gray-50 rounded-xl">
                        <Image src="/books.png" alt="GED Books" fill className="object-contain" />
                      </div>
                    ...
                    <div className="flex flex-col items-center text-center space-y-4">
                      <div className="relative w-full h-52 md:h-64 bg-gray-50 rounded-xl">
                        <Image src="/question-sheet.png" alt="GED Questions" fill className="object-contain" />
                      </div>
                    ...
                    <div className="flex flex-col items-center text-center space-y-4">
                      <div className="relative w-full h-52 md:h-64 bg-gray-50 rounded-xl">
                        <Image src="/notes-img.png" alt="GED Notes" fill className="object-contain" />
                      </div>
            ...
            <aside className="lg:col-span-1 space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-md border border-[#E2E8F0] p-5">
                  <h3 className="font-semibold text-[#2D3748] mb-3">GED Score Predictor</h3>
                  ...
                  <div className="w-full bg-[#EDF2F7] h-2 rounded-full mt-3">
                    <div className="bg-[#1E4A76] h-2 rounded-full" style={{ width: `${(dashboardStats.predictedScore / dashboardStats.targetScore) * 100}%` }}></div>
                  </div>
                </div>
                ...
                <div className="bg-[#EBF5FF] rounded-xl p-4 border border-[#B8D1E6]">
                  <div className="flex gap-2">
                    ...
                    <p className="text-xs text-[#2D3748]">
                      <span className="font-semibold">GED Tip:</span> The GED Ready official practice test is the best indicator of your readiness. Focus on weak areas identified in diagnostic reports.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col-reverse md:flex-row items-center gap-8">
                <div className="w-full md:w-2/3 text-center md:text-left">
                  ...
                  <p className="mt-3 text-[#4A5568] font-times text-[17px] md:text-lg max-w-3xl mx-auto md:mx-0 md:px-0 px-3">
                    GED Overview — Format, sections, scoring, and essential strategies to guide your preparation and test-day performance.
                  </p>
                  <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:gap-4 justify-center md:justify-start md:px-0 px-3">
                    <Link
                      href="ged/Practice-Questions"
                      ...
                      aria-label="Get started with GED preparation"
                    >
                      Start Preparing
                    </Link>
                    <button
                  ...
                  <div className="w-56 bg-white border border-[#E2E8F0] rounded-2xl p-4 shadow-lg hover:shadow-xl transition">
                    ...
                    <div className="mt-3 text-center">
                      <p className="text-sm text-[#718096]">
                        Four subjects, computer-based, high school equivalency credential.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="max-w-6xl mx-auto md:px-4 px-2">
              <div className="w-full py-4 text-center">
                ...
                <h2 className="text-[#4A5568] font-times text-[17px] max-w-3xl mx-auto mt-2">
                  GED exam format, subject breakdown, and timing information to help you prepare effectively.
                </h2>
              </div>
              ...
              <div className="mt-6">
                ...
                <p className="text-sm text-[#718096] mt-3">* Timing includes breaks; each subject is taken separately.</p>
              </div>
            </div>
          </section>

          {/* Topic / Section Weight Section */}
            ...
            <div className="max-w-6xl mx-auto">
              <div className="flex flex-col-reverse md:flex-row items-center gap-4 mb-10">
                <div className="w-full md:w-2/3 text-center md:text-left">
                  ...
                  <p className="mt-3 text-[#4A5568] font-times text-[17px] md:text-lg max-w-3xl mx-auto md:mx-0 md:px-0 px-3">
                    GED content distribution and high-yield areas to prioritise in your preparation. Use the quick bars to scan high-weight focuses and drill down to practice.
                  </p>
                  <div className="mt-6 flex flex-wrap gap-3 justify-center md:justify-start">
                    <Link href="/ged/Practice-Questions" className="inline-flex items-center gap-2 px-5 py-3 rounded-lg bg-[#1E4A76] text-white text-sm font-semibold shadow hover:bg-[#163A5E] transition hover:shadow-lg">
                      Explore Sections
                    </Link>
                ...
                {subjects.map((s) => (
                  <article key={s.title} className="bg-white border border-[#E2E8F0] rounded-2xl p-6 shadow-sm hover:shadow-md transition transform hover:-translate-y-1 flex flex-col h-full">
                    ...
                    <div className="mt-auto flex items-center justify-between pt-6">
                      <a href={`/ged/Practice-Questions#${s.title.toLowerCase().replace(/\s+/g, '-')}`} className="text-sm font-medium text-[#1E4A76] hover:underline">Practice →</a>
          ...
          {/* ========== CONTENT DOMAINS & QUESTION DISTRIBUTION SECTION ========== */}
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-[#4A5568] font-times text-[17px] max-w-3xl mx-auto">
                  Detailed breakdown of what each GED subject tests, including specific skills and approximate question counts.
                </p>
              </div>

              {/* Always shown tables (first two) */}
              <ContentDomainTable
                title="Reasoning Through Language Arts"
                timeInfo="150 min • ~46‑51 questions + 1 essay"
                domains={languageArtsDomains}
              />
              <ContentDomainTable
                title="Mathematical Reasoning"
                timeInfo="115 min • ~46 questions"
                domains={mathDomains}
              />

              {/* Conditionally shown tables (last two) */}
              {showAllContentTables && (
                <>
                  <ContentDomainTable
                    title="Science"
                    timeInfo="90 min • ~34 questions"
                    domains={scienceDomains}
                  />
                  <ContentDomainTable
                    title="Social Studies"
                    timeInfo="70 min • ~35 questions"
                    domains={socialStudiesDomains}
                  />
                </>
              )}
              ...
              <div className="flex justify-center mt-4">
                <button
                  onClick={() => setShowAllContentTables(!showAllContentTables)}
                  className="px-6 py-2 rounded-lg bg-[#1E4A76] text-white text-sm font-medium hover:bg-[#163A5E] transition shadow-md hover:shadow-lg flex items-center gap-2"
                >
                  {showAllContentTables ? (
                    <>
